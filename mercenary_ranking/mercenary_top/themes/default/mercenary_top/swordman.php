...
<h2>Swordman Mercenary Ranking</h2>
...
<table class="horizontal-table">
	<tr>
		...
		<th><?php echo $paginator->sortableColumn('sword_faith', 'Loyalty') ?></th>
		<th><?php echo $paginator->sortableColumn('sword_calls', 'Contracts') ?></th>
	...
	<tr>
		...
		<td>
			<?php echo number_format($char->sword_faith) ?>
		</td>
		<td>
			<?php echo number_format($char->sword_calls) ?>
		</td>
		<td>
