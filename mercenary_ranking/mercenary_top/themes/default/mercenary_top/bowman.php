...
<h2>Bowman Mercenary Ranking</h2>
...
<table class="horizontal-table">
	<tr>
		...
		<th><?php echo $paginator->sortableColumn('arch_faith', 'Loyalty') ?></th>
		<th><?php echo $paginator->sortableColumn('arch_calls', 'Contracts') ?></th>
	...
	<tr>
		...
		<td>
			<?php echo number_format($char->arch_faith) ?>
		</td>
		<td>
			<?php echo number_format($char->arch_calls) ?>
		</td>
		<td>
